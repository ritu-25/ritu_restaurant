			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Ritu Saini resturent</span></h1>
						<h4>Little Story</h4>
						<p> Restaurants in Jaipur, Jaipur Restaurants, Bopal restaurants, Best Bopal restaurants, West Ahmedabad restaurants, Gujarati Restaurants in Ahmedabad, Gujarati near me, Gujarati Restaurants in West Ahmedabad, </p>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Special Menu</h2>
						<p>You can tell alot about a fellow's character by his way of eating jellybeans.</p>
					</div>
				</div>
			</div>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">MaliResto</a>
